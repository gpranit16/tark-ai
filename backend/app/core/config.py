...
class Settings(BaseSettings):
    ...
    deep_research_max_queries: int = Field(default=6, alias="DEEP_RESEARCH_MAX_QUERIES")
    deep_research_max_results_per_query: int = Field(default=5, alias="DEEP_RESEARCH_MAX_RESULTS_PER_QUERY")
    deep_research_max_images: int = Field(default=3, alias="DEEP_RESEARCH_MAX_IMAGES")
    pollinations_api_key: str | None = Field(default=None, alias="POLLINATIONS_API_KEY")
    deep_research_gemini_model: str = Field(default="gemini-3.5-flash-lite", alias="DEEP_RESEARCH_GEMINI_MODEL")
